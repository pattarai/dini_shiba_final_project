...
class DisnehCalci extends StatefulWidget {
  @override
  _DisnehCalciState createState() => _DisnehCalciState();
}

class _DisnehCalciState extends State<DisnehCalci> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(image: NetworkImage('https://images.unsplash.com/photo-1505506874110-6a7a69069a08?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1234&q=80'),
          fit: BoxFit.cover),
          ),
         child: Column(
          children: <Widget>[
